function [StructureMatrix, NullSpace] = m2T(CableAttachments, CableVectors)%#codegen
% M2T - Calculate the structure matrix for the given cable attachment
% points and cable vectors of a 2T cable robot
% 
%   STRUCTUREMATRIX = M2T(CABLEATTACHMENTS, CABLEVECTORS) determines the
...
%
%   [STRUCTUREMATRIX, NULLSPACE] = M2T(...) also returns the nullspace of
